...
import assets from './task/assets.js'
import publicRoot from './task/public_root.js'
...
const watcher = () => {
  ...
  gulp.watch(path.publicRoot.watch, publicRoot)
}
...
const build = gulp.series(
  clear,
  gulp.parallel(html, scss, js, img, font, sprite, assets, publicRoot)
)

const dev = gulp.series(build, gulp.parallel(watcher, server))

// Tasks
export {html, scss, js, font, sprite, img, assets, publicRoot}
